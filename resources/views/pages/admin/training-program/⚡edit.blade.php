...
new class extends Component {
    ...
    {
        if (in_array($property, ['intake_id', 'school_year_start'], true)) {
            $this->refreshVersion();
        }
    ...
    public function confirmSave(): void
    {
        ...
        $this->success('Cập nhật chương trình đào tạo thành công!', redirectTo: route('admin.training-program.index'));
    }
};
?>
    ...
    <div class="grid lg:grid-cols-12 gap-5 custom-form-admin text-[14px]!">
        ...
        <div class="col-span-12 lg:col-span-3 flex flex-col gap-5">
            <x-card title="Hành động" shadow separator class="p-3!">
                ...
                <x-button label=" Trở lại " class="bg-warning text-white w-full my-1" link="{{ route('admin.training-program.index') }}"/>
            </x-card>
