...
<div>
    ...
    <div class="bg-fita">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-8 w-full container mx-auto px-4 md:px-0 py-8 lg:py-12 gap-8 lg:gap-10 text-white text-[15px] font-barlow">
